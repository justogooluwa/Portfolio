     ...
     return(
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
           ...
           <p className="text-lg text-gray-600 max-w-2xl mx-auto">My Expertise Across Development Stack</p>
        </div>
        ...
        <h2 className="text-3xl lg:text-4xl font-extrabold text-gray-800 mb-10 text-center">What I Do</h2>
        <div className="max-w-3xl mx-auto space-y-8">
            <div>
          <div className="flex justify-between mb-2">
           <span className="text-lg font-semibold text-gray-700">Web Development</span>
           <span className="text-gray-600 font-medium">95%</span>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden">
           <div className="h-4 rounded-full bg-gradient-to-r from-green-400 to-green-600" style={{width:'95%'}}></div>
          </div>
          </div>

          <div>
              <div className="flex justify-between mb-2">
           <span className="text-lg font-semibold text-gray-700">Local SEO</span>
           <span className="text-gray-600 font-medium">85%</span>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden">
           <div className="h-4 rounded-full bg-gradient-to-r from-blue-400 to-blue-600" style={{width:'85%'}}></div>
          </div>
          </div>
           <div>
              <div className="flex justify-between mb-2">
           <span className="text-lg font-semibold text-gray-700">E-commerce Solutions</span>
           <span className="text-gray-600 font-medium">90%</span>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden">
           <div className="h-4 rounded-full bg-gradient-to-r from-pink-400 to-pink-600" style={{width:'90%'}}></div>
          </div>
          </div>
           <div>
              <div className="flex justify-between mb-2">
           <span className="text-lg font-semibold text-gray-700">CMS Development</span>
           <span className="text-gray-600 font-medium">80%</span>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden">
           <div className="h-4 rounded-full bg-gradient-to-r from-purple-400 to-purple-600" style={{width:'80%'}}></div>
          </div>
          </div>
        </div>
        </div>
